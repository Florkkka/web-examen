...
function getURL(path) {
    let url = new URL(`https://edu.std-900.ist.mospolytech.ru/`);
    url.searchParams.set("api_key", "3a36bca1-9988-4b51-9577-a62e33d78be3");
    return url;
}
...
function formUpd(modal) {
    ...
    let option1Price = option1 ? price * -0.25 : 0;
